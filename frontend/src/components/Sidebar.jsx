    ...
    <>
      ...
      <div style={{
        ...
        <div style={{
          ...
          {onOpenPaywall && (
            <button onClick={() => { onOpenPaywall(); setOpen(false); }} style={{
              display: "flex", alignItems: "center", gap: "12px",
              background: "transparent", border: `1.5px solid ${th.accent}33`,
              borderRadius: "14px", padding: "12px 16px", cursor: "pointer",
              marginBottom: "20px", width: "100%",
            }}>
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ color: th.text, flexShrink: 0 }}><rect x="1" y="4" width="22" height="16" rx="2" ry="2"/><line x1="1" y1="10" x2="23" y2="10"/></svg>
              <span style={{ fontFamily: "Nunito, sans-serif", fontWeight: 800, fontSize: "0.9rem", color: th.text }}>Plans & pricing</span>
            </button>
          )}
